...
#include <fstream>
namespace Shapes3D{
    ObjWriter::ObjWriter() {} // constructor
    ObjWriter::~ObjWriter() {} // destructor
    void ObjWriter::write(std::string &FilePath, Triangulation &triangulationObj){ // creates txt file for gnuplot
