...
#include <vector>
#include <map>
Shapes3D::StlReader::StlReader() {} // constructor
Shapes3D::StlReader::~StlReader() {} // destructor
void Shapes3D::StlReader::read(const std::string &filePath, Triangulation &triangulationObj){ // read the stl file to store the data in structured way
