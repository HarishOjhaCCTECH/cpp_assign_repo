...
// below function converts the double and int data stored in lot(list of triangles) and lop(list of points) to string to be stored in txt file for plotting
void STLwriter::txtGeneration(std::string stlFilePath, std::vector<Triangle> & lot, std::vector<Point> & lop){
    ...
    outputFile.open("D://harish_ojha_workspace/cpp_assignments/stl_a3/GNUfiles/file_for_gnuplot.txt");
