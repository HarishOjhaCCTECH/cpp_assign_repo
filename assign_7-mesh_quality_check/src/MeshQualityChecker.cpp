...
#include <algorithm>
#include <numeric>
Shapes3D::MeshQualityChecker::MeshQualityChecker(Triangulation &triangulation) : triangulation(triangulation) {} // parameterise constructor
Shapes3D::MeshQualityChecker::~MeshQualityChecker() {} // destructor
double Shapes3D::MeshQualityChecker::calculateTriangleArea(const Shapes3D::Triangle &triangle){ // calculates area of a triangle
...
double Shapes3D::MeshQualityChecker::calculateTotalSurfaceArea(const Shapes3D::Triangulation &triangulation){ // calculating total surface area of all triangles in the mesh
...
double Shapes3D::MeshQualityChecker::calculateMeshDensity(const Shapes3D::Triangulation &triangulation){ // calculate mesh density
...
double Shapes3D::MeshQualityChecker::calculateTriangleAspectRatio(const Shapes3D::Triangle &triangle){ // calculating aspect ratio of a triangle
...
double Shapes3D::MeshQualityChecker::calculateAspectRatio(const Shapes3D::Triangulation &triangulation){ // calculates aspect ratio
...
double Shapes3D::MeshQualityChecker::calculateAspectRatioSkewness(const Shapes3D::Triangulation &triangulation){
    std::vector<double> aspectRatios; // Vector to store aspect ratios of all triangles
    for (const Shapes3D::Triangle &triangle : triangulation.triangles()){
        double aspectRatio = calculateTriangleAspectRatio(triangle);
        aspectRatios.push_back(aspectRatio);
    }
    double idealAspectRatio = 1.0; // ideal aspect ratio
